[![Stars](https://img.shields.io/github/stars/RanaAhmar/pandas-optimization-hacks?style=for-the-badge)](https://github.com/RanaAhmar/pandas-optimization-hacks/stargazers) [![Issues](https://img.shields.io/github/issues/RanaAhmar/pandas-optimization-hacks?style=for-the-badge)](https://github.com/RanaAhmar/pandas-optimization-hacks/issues) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://github.com/RanaAhmar/pandas-optimization-hacks/blob/main/LICENSE)

# 🐼 Pandas Optimization Hacks

Stop getting `MemoryError`. Advanced techniques for processing massive datasets efficiently. By **Ahmar Hussain** (**Stackaura**).
